...
export function buildAffiliateLink(
  ...
  if (iata && departureDate) {
    ...
    return `https://www.kiwi.com/fr/search/results/EAP/${iata}/${departureDate}/${retDate}/return/?affilid=${KIWI_AFFILID}`;
  }
  
  if (iata) {
    return `https://www.kiwi.com/fr/search/results/EAP/${iata}/anytime/anytime/return/?affilid=${KIWI_AFFILID}`;
  }
